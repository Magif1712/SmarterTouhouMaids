...
import com.github.magif1712.smarter_touhou_maids.features.smarter.agent.reflex_arc_system_agent.effector.bionic_muscle_effector.muscle.AntagonisticPair;
import com.github.magif1712.smarter_touhou_maids.features.smarter.agent.reflex_arc_system_agent.effector.bionic_muscle_effector.muscle.MuscleGroup;
import com.github.magif1712.smarter_touhou_maids.features.smarter.agent.reflex_arc_system_agent.effector.bionic_muscle_effector.semantics.AntagonisticPairDescriptor;
import com.github.magif1712.smarter_touhou_maids.features.smarter.agent.reflex_arc_system_agent.effector.bionic_muscle_effector.semantics.MuscleGroupDescriptor;
import com.github.magif1712.smarter_touhou_maids.features.smarter.agent.reflex_arc_system_agent.effector.bionic_muscle_effector.semantics.MuscleGroupId;
 ...
 * <p>
 * 对标 {@link com.github.magif1712.smarter_touhou_maids.features.smarter.agent.reflex_arc_system_agent.sensor.possession_sensor.PossessionSensor}
 * （感受器入口），把不实在的 256 bits 神经信号，用实在的肌肉力学链转化为实在的操作要求。编排三步：
 * <ol>
 *   <li>所有肌群 {@link MuscleGroup#tick} —— 运动单元池加权求和（空间容错）
 *       + {@link com.github.magif1712.smarter_touhou_maids.features.smarter.agent.reflex_arc_system_agent.effector.bionic_muscle_effector.muscle.TensionIntegrator}
 *       低通滤波（时间容错）</li>
