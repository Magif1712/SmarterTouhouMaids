...
import com.github.magif1712.smarter_touhou_maids.features.smarter.agent.reflex_arc_system_agent.ai.process_ai.process.urana_process.nn.bnn.containers.io.gradient.BnnInputLayerGradient;
...
public class BnnIOLayerGradients implements AutoCloseable {
    ...
    private final BnnInputLayerGradient inputLayerGradient;
    private final BnnOutputLayerGradient outputLayerGradient;
    /**
    ...
    public BnnIOLayerGradients(int inputSize, int outputSize) {
        this.inputLayerGradient = new BnnInputLayerGradient(new IntVector(inputSize));
        this.outputLayerGradient = new BnnOutputLayerGradient(new IntVector(outputSize));
