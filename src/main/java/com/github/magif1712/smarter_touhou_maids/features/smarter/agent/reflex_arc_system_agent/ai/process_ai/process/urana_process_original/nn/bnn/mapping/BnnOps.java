 ...
 * 属于 nn/bnn 实现层，不暴露给 urana。urana 通过 {@link com.github.magif1712.smarter_touhou_maids.features.smarter.agent.reflex_arc_system_agent.ai.process_ai.process.urana_process_original.nn.INeuralNetwork#gradientToInput}
 * 间接调用。
 */
public class BnnOps {
