    ...
    jlong stream_handle)
{
    ...
    try
    {
        backwardLayerBridge(da0, da1, fz, b, p, q, l, r, dz_workspace, batch_size, n_curr, n_prev, reinterpret_cast<cudaStream_t>(stream_handle));
    }
    ...
    jlong stream_handle)
{
    ...
    try
    {
        backwardGradientDescentLayerBridge(da0, da1, a_prev, fz, b, p, q, l, r, dz_workspace, n_curr, n_prev, reinterpret_cast<cudaStream_t>(stream_handle));
    }
