...
JNIEXPORT void JNICALL JNI_METHOD(features_smarter_agent_reflex_1arc_1system_1agent_ai_process_1ai_process_urana_1process_1original_nn_bnn_mapping_training, BnnGradientOpsNative, _1backwardLayer)(
    JNIEnv* env,
    jclass clazz,
    jlong da0_handle,
    jlong da1_handle,
...
JNIEXPORT void JNICALL JNI_METHOD(features_smarter_agent_reflex_1arc_1system_1agent_ai_process_1ai_process_urana_1process_1original_nn_bnn_mapping_training, BnnGradientOpsNative, _1backwardGradientDescentLayer)(
    JNIEnv* env,
    jclass clazz,
    jlong da0_handle,
    jlong da1_handle,
