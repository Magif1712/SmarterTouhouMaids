    ...
    cudaStream_t stream)
{
    ...
    bnn_push_p<<<grid_push, block, 0, stream>>>(a_prev_pad, q, a_curr, P, n, n_words);
    bnn_pull_lr<true><<<grid_pull, block, 0, stream>>>(a_prev_pad, a_curr, fz, l, r, b, n_words, input_n_words);
}
    ...
    cudaStream_t stream)
{
    ...
    bnn_push_p<<<grid_push, block, 0, stream>>>(a_prev_pad, q, a_curr, P, n, n_words);
    bnn_pull_lr<false><<<grid_pull, block, 0, stream>>>(a_prev_pad, a_curr, nullptr, l, r, b, n_words, input_n_words);
}