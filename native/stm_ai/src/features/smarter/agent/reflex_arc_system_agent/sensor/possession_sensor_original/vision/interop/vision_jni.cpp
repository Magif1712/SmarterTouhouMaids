...
JNI_METHOD(features_smarter_agent_reflex_1arc_1system_1agent_sensor_possession_1sensor_1original_vision, VisionNative, _1captureScreenViaSnapshot)(
...
JNIEXPORT void JNICALL
JNI_METHOD(features_smarter_agent_reflex_1arc_1system_1agent_sensor_possession_1sensor_1original_vision, VisionNative, _1cleanup)(
    JNIEnv* env, jclass clazz
) {
    try {
