...
JNI_METHOD(features_smarter_agent_reflex_1arc_1system_1agent_1original_sensor_possession_1sensor_vision, VisionNative, _1captureScreenViaSnapshot)(
    ...
    try {
        ...
        cudaError_t err = captureScreenViaSnapshotOriginalBridge(
...
JNIEXPORT void JNICALL
JNI_METHOD(features_smarter_agent_reflex_1arc_1system_1agent_1original_sensor_possession_1sensor_vision, VisionNative, _1cleanup)(
    JNIEnv* env, jclass clazz
) {
    try {
        cleanupVisionOriginalBridge();
    }
