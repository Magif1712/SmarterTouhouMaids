...
JNIEXPORT void JNICALL JNI_METHOD(features_smarter_agent_reflex_1arc_1system_1agent_1original_ai_process_1ai_process_urana_1process_1original_nn_bnn_standard_1bnn, ElasticOpsNative, _1reconnectOnInputChange)(
    JNIEnv* env, jclass, jlong inputHandle, jlong prevInputHandle, jlong qHandle, jlong streamHandle)
{
    try {
        ...
        ElasticReconnectOnInputChange_original(currentInput, prevInput, q, reinterpret_cast<cudaStream_t>(streamHandle));
    }
