...
# C 侧模板 <bool StoreTrace> 编译期优化，JNI 层据 traceZ==0 选 bridge。
#
# _cnnRefreshCache 由 p 重算 idx/w（非热路径，构造/loadFromFile 后一次性调用）。


def _cnnForwardLayer(x, p, q, l, r, b, idx0, idx1, w0, w1, sizeA0, sizeA1, stream, y, traceZ, traceY): ...


def _cnnRefreshCache(p, sizeA0, sizeA1, stream, idx0, idx1, w0, w1): ...